namespace BeansCuest {
    ...
    export async function scene1_2(): fS.SceneReturn {
        ...
        await letCharactersHaveDialogue([[CHARACTERS.Bean, script.Bean.texts.T0001]], script);
    ...
    async function optionC1() {
        await letCharactersHaveDialogue([[CHARACTERS.Bean, script.Bean.texts.T0002]], script);
